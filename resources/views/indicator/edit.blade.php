                    ...
                    <form method="post" action="{{ route('indicator.update', $data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="name" type="text" class="form-control" name="name" required autocomplete="name" autofocus value="{{$data->name}}"  maxlength="35">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <textarea name="desc" cols="50" rows="3" class="form-control input-lg"  maxlength="75" required>{{$data->desc}}</textarea>
                            </div>
                        </div>
