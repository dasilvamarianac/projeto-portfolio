  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Exclusão de indicador</h5>
      ...
      <div class="modal-footer">  
        <form method="post" action="{{ route('member.destroy', 1) }}" enctype="multipart/form-data" id="form_del">  
          @csrf 
          @method('PATCH')
          <div class="col-md-6">
